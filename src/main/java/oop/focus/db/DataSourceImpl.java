...
public class DataSourceImpl implements DataSource {
    ...
    public final SingleDao<Person> getPersons() {
        return Objects.requireNonNullElseGet(this.persons, () ->
                new CachedDao<>(new ParserImpl<>("person", a -> new PersonImpl(a.remove(1),
    ...
    public final SingleDao<Category> getCategories() {
        return Objects.requireNonNullElseGet(this.categories,
                () -> new CachedDao<>(new ParserImpl<>("category",
    ...
    public final SingleDao<Account> getAccounts() {
        return Objects.requireNonNullElseGet(this.accounts, () ->
                new CachedDao<>(new ParserImpl<>("account", a -> new AccountImpl(a.remove(1),
                        this.colors.getValue(Integer.parseInt(a.remove(1))).orElse(null),
    ...
    public final SingleDao<HotKey> getHotKeys() {
        return Objects.requireNonNullElseGet(this.hotKeys,
                () -> new CachedDao<>(new ParserImpl<>("quick_action",
    ...
    private SingleDao<Pair<Integer, Integer>> getGroupTransactionPersons() {
        return Objects.requireNonNullElseGet(this.groupTransactionPersons,
                () -> new CachedDao<>(new ParserImpl<>("group_transaction_persons",
    ...
    private SingleDao<Pair<Integer, Integer>> getEventPerson() {
        return Objects.requireNonNullElseGet(this.eventPersons, () ->
                new CachedDao<>(new ParserImpl<>("event_person",
                        a -> new Pair<>(Integer.parseInt(a.remove(1)), Integer.parseInt(a.remove(1))),
