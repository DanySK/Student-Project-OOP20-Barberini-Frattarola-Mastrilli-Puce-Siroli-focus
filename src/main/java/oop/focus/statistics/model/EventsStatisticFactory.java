...
public interface EventsStatisticFactory {
    ...
    /**
     * Creates a DataCreator that maps each event to a {@link Pair} of {@link LocalDate} and Integer.
    ...
    /**
     * Creates a DataCreator that maps each event that occurred between
